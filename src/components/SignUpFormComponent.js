        ...
        return (
            ...
            <form onSubmit={(e) => { this.props.handleSubmit(e, this.state.user); }}>
                ...
                <Grid item xs={20}>
                    ...
                    <TextField required name='password_confirmation' variant="outlined" type='password' value={this.state.user.password_confirmation} onChange={this.handleChange} /><br/>
